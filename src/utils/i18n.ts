...
const strings = {
  en: {
    ...
    txtOnlyMsg: '"{title}" is only available as plain text \u2014 EPUB and PDF are not offered for this book.\n\nOpen the plain text file in a new tab?',
  ...
  es: {
    ...
    fromUrl: 'URL',
    browse: 'Buscar',
    formatsNote: 'PDF \u00b7 EPUB \u00b7 HTML \u00b7 Markdown \u00b7 Texto plano',
    ...
    txtOnlyMsg: '"{title}" solo est\u00e1 disponible en texto plano \u2014 EPUB y PDF no est\u00e1n disponibles.\n\n\u00bfAbrir el archivo de texto en una nueva pesta\u00f1a?',
...
export function formatTimeLeft(lang: Lang, remainingWords: number, wpmValue: number): string {
